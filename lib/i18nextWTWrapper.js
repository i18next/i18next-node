...
var defaults = {
    ...
    index: [
        ...
        '<head>',
          ...
          '<!-- Application styles. -->',
          '<link rel="stylesheet" href="__path__/static/css/i18nextWT.css">',
        '</head>',
        ...
        '<body>',
          ...
          '<!-- Application source. -->',
          '<script src="__path__/static/js/i18nextWT.js"></script>',
...
module.exports = {
    ...
    serve: function(app, options) {
        ...
        app.use(options.path + '/static', express.static(path));
